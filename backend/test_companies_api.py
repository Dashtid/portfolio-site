    ...
    async with async_session_maker() as session:
        ...
        if companies:
            for i, company in enumerate(companies, 1):
                ...
                print(f"Responsibilities: {company.responsibilities} (type: {type(company.responsibilities)})")
                ...
                try:
                    ...
                    print(f"✓ Pydantic serialization SUCCESS")
                    print(f"  Response: {response.model_dump_json()[:200]}...")
                except Exception as e:
                    print(f"✗ Pydantic serialization FAILED:")
