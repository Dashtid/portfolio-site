    ...
    companies = [
        {
            ...
            # Public-surface rule: describe the domain generically ("regulated
            # medical software"). The specific product category is not ours to
            # publish, and this string renders on the public homepage.
