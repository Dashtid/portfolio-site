...
test.describe('Homepage', () => {
  test('should load successfully', async ({ page }) => {
    ...
    // Check hero section
    await expect(page.locator('h1')).toContainText('Cybersecurity and Quality Assurance')
  ...
  test('should have proper meta tags', async ({ page }) => {
    ...
    expect(description).toContain('Biomedical Engineer and Cybersecurity Specialist')
