...
test.describe('Navigation', () => {
  ...
  test('should highlight active navigation items', async ({ page }) => {
    ...
    await expect(page.locator('[data-scroll="experience"]')).toHaveClass(/active/)
    ...
    await expect(page.locator('[data-scroll="experience"]')).not.toHaveClass(/active/)
  })
  ...
  test('should navigate to external pages', async ({ page, context }) => {
    ...
    const externalLinks = [
      { link: 'a[href="scania.html"]', expectedTitle: /Scania/ },
      { link: 'a[href="hermes.html"]', expectedTitle: /Hermes/ },
      { link: 'a[href="karolinska.html"]', expectedTitle: /Karolinska/ }
    ]
